...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSDictionary<NSString *, id> * _Nonnull customVariables SWIFT_DEPRECATED_OBJC("Swift property 'Usabilla.customVariables' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");)
+ (NSDictionary<NSString *, id> * _Nonnull)customVariables SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift property 'Usabilla.customVariables' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
+ (void)setCustomVariables:(NSDictionary<NSString *, id> * _Nonnull)newValue SWIFT_DEPRECATED_OBJC("Swift property 'Usabilla.customVariables' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
+ (void)sendEvent:(NSString * _Nonnull)event;
...
///
- (void)formDidCloseWithFormID:(NSString * _Nonnull)formID withFeedbackResults:(NSArray * _Nonnull)results isRedirectToAppStoreEnabled:(BOOL)isRedirectToAppStoreEnabled;
...
/// \param isRedirectToAppStoreEnabled Indicates whether or not the form is set to redirect to the App Store
///
- (void)formWillCloseWithForm:(UINavigationController * _Nonnull)form formID:(NSString * _Nonnull)formID withFeedbackResults:(NSArray * _Nonnull)results isRedirectToAppStoreEnabled:(BOOL)isRedirectToAppStoreEnabled;
...
///
- (void)campaignDidCloseWithFeedbackResult:(id _Nonnull)result isRedirectToAppStoreEnabled:(BOOL)isRedirectToAppStoreEnabled;
@end
